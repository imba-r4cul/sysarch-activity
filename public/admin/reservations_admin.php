...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/admin/reservations_admin.css">
</head>
...
<body>
                                ...
                                <tr
                                    ...
                                    <td class="action-buttons-cell text-center">
                                        <?php if ($status === 'Pending'): ?>
                                            <!-- Approve Form -->
                                            <form method="POST" action="reservations_admin.php" style="display:inline;" onsubmit="return confirm('Are you sure you want to approve this reservation?');">
                                                <input type="hidden" name="action" value="approve">
                                                <input type="hidden" name="reservation_id" value="<?= $record['id'] ?>">
                                                <button class="action-btn approve" type="submit" title="Approve Reservation">
    ...
    <div class="modal-overlay" id="rejectModal">
        <div class="modal-box">
            <form method="POST" action="reservations_admin.php">
                ...
                <div class="modal-footer">
                    ...
                    <button class="modal-btn submit" type="submit">Reject</button>
                </div>
            </form>
        </div>
    </div>
